 ...
 */
/*
 * Tuning Tips (Simplified)

If the robot drifts left: One or two motors (likely M1/M4, based on encoder sign inversions) are weaker. Increase Ki for those motors to push them harder over time.
If motors wobble or overshoot: Increase Kd to calm them down or lower Kp to reduce aggressive corrections.
If motors are slow to reach speed: Increase Kp for faster response or Ki for persistent effort.
 */
